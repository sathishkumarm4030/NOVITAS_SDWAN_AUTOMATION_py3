...
*** Test Cases ***
NV_DUAL_CPE_DUAL_INTERNET_SANITY_01
...
NV_DUAL_CPE_DUAL_INTERNET_VRRP_01
    [Documentation]    Check grp summary
    [Tags]    vrrp
    CHECK VRRP GRP SUMMARY


#NV_DUAL_CPE_DUAL_INTERNET_VRRP_02
#    [Documentation]    Check grp summary
#    [Tags]    vrrp2
#    CHECK VRRP GRP SUMMARY
...
NV_DUAL_CPE_DUAL_INTERNET_TRAFFIC_STEERING_02
    ...
    CPE1.show_defpolicy_path_state    ${plcyrule_1}    ${CPE3['Device_name']}
    ${result}    CPE1.show_session_sdwan_detail    source_port=2001
    CHECK RESULT    actual=${result}    expected=${CPE1['WAN2_NAME']}
    CHECK RESULT    actual=${result}    expected=sdwan-rule-name\\s+${plcyrule_1}
    spirent1.Start Stream Traffic    ${stream3['stream_id']}
    sleep    40s
    SHOW INTERFACE PORT STATISTICS BRIEF
...
NV_DUAL_CPE_DUAL_INTERNET_TRAFFIC_STEERING_03
...
NV_DUAL_CPE_DUAL_INTERNET_TRAFFIC_STEERING_04
...
NV_DUAL_CPE_DUAL_INTERNET_QOS_01
...
NV_DUAL_CPE_DUAL_INTERNET_QOS_02
...
NV_DUAL_CPE_DUAL_INTERNET_QOS_03
