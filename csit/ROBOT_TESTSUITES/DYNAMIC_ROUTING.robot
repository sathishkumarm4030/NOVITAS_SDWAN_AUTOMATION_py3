...
Library           ../libraries/CiscoLib.py    ${CISCOCPE1}    topofile=CISCO_Devices.csv    WITH NAME    CISCOCPE1
Library           ../libraries/CiscoLib.py    ${CISCOCPE2}    topofile=CISCO_Devices.csv    WITH NAME    CISCOCPE2
