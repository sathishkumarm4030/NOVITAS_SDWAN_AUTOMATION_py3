...
def Do_New_Org_Deployment():
    ...
    no_of_vrfs = input("NUMBER OF VRFS :")
    # org_name = "JAN232"
    # org_id = "123"
    # no_of_vrfs = "4"

    VD1 = VersaLib('POD2_VD1', topofile="Devices.yml")
    main_logger = VD1.main_logger
    main_logger.info("ORG NAME:" + org_name)
    VD1.NO_OF_VRFS = no_of_vrfs
    run_result = ""
    print(("AVAILBALE NODEs:" + str(list(VD1.ctlr_dict.keys()))))
    nodes = input("Enter Node names. eg: MUM BLR\n")
    nodes = nodes.upper()
    # nodes = "BLR"
